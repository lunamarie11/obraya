...
import {
  ...
  Settings, HardHat, Plus, Bell, ArrowLeft,
} from "lucide-react";
    ...
    <aside className="fixed left-0 top-0 h-screen w-64 bg-dark-900 text-white flex flex-col z-50">
      ...
      <div className="px-6 py-5 flex items-center gap-3">
        ...
        <div>
          ...
          <div className="text-[10px] font-bold text-navy-500 uppercase tracking-wider">Arquitecto</div>
        </div>
      </div>
      ...
      <div className="px-4 mb-4">
        <button className="w-full flex items-center gap-2 px-4 py-2.5 bg-navy-500 hover:bg-navy-600 text-white rounded-lg text-sm font-semibold transition-colors">
          ...
          return (
            ...
            >
              ...
              {"badge" in item && item.badge && (
                <span className="ml-auto bg-navy-500 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full">
                  {item.badge}
                </span>
              )}
            </Link>
      ...
      <div className="px-3 pb-4 space-y-1">
        ...
        <div className="mt-4 flex items-center gap-3 px-3 py-3 rounded-lg bg-white/5">
          <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold text-white bg-navy-500">
            MR
          </div>
          <div className="flex-1 min-w-0">
            <div className="text-sm font-semibold truncate">Arq. Marina Rodríguez</div>
            <div className="text-[11px] text-gray-500">Arquitecta</div>
          </div>
        </div>
      </div>
    </aside>
