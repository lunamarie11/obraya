...
import { buyerRegister } from '@/lib/buyer-auth';
...
export default function AccountRegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-tabbar">
      <MarketplaceHeader showSearch={false} showBack backHref="/account" title="Crear cuenta" />
      ...
      <main className="max-w-sm mx-auto px-4 sm:px-6 py-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Creá tu cuenta</h1>
          <p className="text-slate-400 text-sm mt-1">Rápido y simple, para hacer seguimiento de tus pedidos.</p>
        </div>
        ...
        <div className="card-ios p-7">
          ...
          <p className="text-center text-sm text-slate-400 mt-6">
            ¿Ya tenés cuenta?{' '}
            <Link href="/account" className="text-orange-500 font-semibold hover:underline">
              Ingresá
            </Link>
          </p>
        </div>
